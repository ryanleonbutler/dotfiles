...
M.nmap("<leader>c", "<cmd>Telescope command_palette<CR>")
M.nmap("<leader>f", "<cmd>Telescope find_files<CR>")
M.nmap("<leader>s", "<cmd>Telescope live_grep<CR>")
M.nmap("<leader>b", "<cmd>Telescope buffers<CR>")
M.nmap("<leader>t", "<cmd>Telescope help_tags<CR>")
M.nmap("<leader>e", "<cmd>Telescope file_browser<CR>")
M.nmap("<leader>p", "<cmd>Telescope project<CR>")
